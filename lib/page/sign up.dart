...
class _SignUpState extends State<SignUp> {
  ...
  void _dologin(){
    ...
    User user=new User(name:_name,password:_pass,email:_email,phone: _phone,confirm_pass:_confirm );
    if(_pass==_confirm){
      Pref.storeUserName(user);
      Pref.loadUserName().then((user){
        print(user.name);
        print(user.email);
        print(user.phone);
        print(user.password);
                    ...
                    child:Row(
                      children:[
                        IconButton(
                          ...
                          onPressed: ()async{
                            await Navigator.push(context, MaterialPageRoute(builder:(ctx)=>Login()));
                          },
                        ),
                      ],
                    ),
